...
import org.excellentcoder.gturbine.archive.Archive.Entry;
import org.excellentcoder.gturbine.archive.Archive.EntryFilter;
...
public class PropertiesLauncher extends Launcher {
    ...
    private static final Class<?>[] URLS_AND_PARENT_PARAMS   = new Class<?>[] { URL[].class,
            ClassLoader.class                               };
    ...
    protected ClassLoader createClassLoader(List<Archive> archives) throws Exception {
        ...
        ClassLoader loader = new LaunchedURLClassLoader(urls.toArray(NO_URLS), getClass()
            .getClassLoader());
    ...
    private ClassLoader wrapWithCustomClassLoader(ClassLoader parent, String className)
                                                                                       throws Exception {
        ...
        notNull(classLoader, "Unable to create class loader for " + className);
        return classLoader;
    }

    private ClassLoader newClassLoader(Class<ClassLoader> loaderClass, Class<?>[] parameterTypes,
                                       Object... initargs) throws Exception {
        try {
            Constructor<ClassLoader> constructor = loaderClass
    ...
    private String getProperty(String propertyKey, String manifestKey, String defaultValue)
            ...
            if (this.home != null) {
                ...
                try (ExplodedArchive archive = new ExplodedArchive(this.home, false)) {
                    ...
                    if (manifest != null) {
                        ...
                        if (value != null) {
                            debug("Property '" + manifestKey + "' from home directory manifest: "
                                  + value);
        ...
        return (defaultValue != null) ? SystemPropertyUtils.resolvePlaceholders(this.properties,
